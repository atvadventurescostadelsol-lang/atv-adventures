...
export default function BatchEntry() {
  ...
  function handleProductChange(entryId, productId) {
    ...
    // Commission is separate, doesn't affect the payment split
  ...
  function handleCommissionMethodChange(entryId, newMethod) {
    const entry = entries.find(e => e.id === entryId);
    if (!entry) return;
